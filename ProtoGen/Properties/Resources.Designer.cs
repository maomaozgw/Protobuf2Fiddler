...
namespace ProtoBuf.CodeGenerator.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 protobuf-net:protogen - code generator for .proto 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 usage: protogen -i:{infile2} [-i:{infile2}] [-o:{outfile}] [-t:{template}] [-p:{prop}[=value]] [-q] [-d]
        ///
